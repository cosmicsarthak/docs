...
I am also proving the client (Aniket Nagla) a custom working backend repo for this project, please refer to that as well for getting better idea. That app is [hosted here](https://api-ai-marketplace.cosmicsarthak.workers.dev/)
