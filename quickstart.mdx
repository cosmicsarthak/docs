...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://dashboard.sarthak.app). To clone the repository
...
<Accordion icon="message-bot" title="Install our Github app">
  ...
  your [dashboard](https://dashboard.sarthak.app). Once the bot has been
...
<Accordion icon="rocket" title="Push your changes">
  ...
  update your docs through our [dashboard](https://dashboard.sarthak.app).
</Accordion>
